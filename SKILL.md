...
5. **관심 있을만한 투자사**
   ...
   - 사업 분야, 주요 투자 업종, 소재지, 투자성격, 업력 조건을 기준으로 해당 기업에 관심을 가질 만한 투자사를 10개 이내로 정리한다.
   - 가능하면 투자사명, 주요 투자 업종, 소재지, 운영규모, 투자성격, 업력 적합성, 매칭 이유, 출처 링크를 제시한다.
6. **해당 분야 투자 펀드**
   - 벤처투자종합포털 모태출자펀드 운용사 찾기를 활용한다. `https://www.vcs.go.kr/web/portal/rsh/list`
   - 주요 투자 업종, 소재지, 결성총액, 투자 단계/업력 조건을 기준으로 해당 분야와 맞는 펀드를 10개 이내로 정리한다.
   - 가능하면 펀드명, 운용사명, 주요 투자 업종, 결성총액, 소재지, 존속기간/결성일, 매칭 이유, 출처 링크를 제시한다.
   - 이 목록은 확정 추천이 아니라 접촉 후보이다. 실제 투자 가능성은 펀드 소진율, 투자 기간, 심사역 관심사, 포트폴리오 충돌 여부를 별도 확인해야 한다.
7. **출처 우선순위**
...
## 8. 🤝 관심 있을만한 투자사/펀드
- **관심 있을만한 투자사**: (VCS 투자자 검색 기반 10개 이내. 투자사명, 주요 투자 업종, 소재지, 운영규모, 매칭 이유, 출처)
- **해당 분야 투자 펀드**: (VCS 모태출자펀드 운용사 찾기 기반 10개 이내. 펀드명, 운용사, 주요 투자 업종, 결성총액, 매칭 이유, 출처)
- **주의**: (접촉 후보일 뿐이며 실제 투자 가능성은 펀드 소진율, 투자 기간, 담당 심사역 관심사, 포트폴리오 충돌 여부 확인 필요)
...
6. VCS 투자자 검색과 모태출자펀드 운용사 찾기를 활용해 관심 있을만한 투자사와 해당 분야 투자 펀드를 각각 10개 이내로 제시합니다.
7. 기업가치 추산은 비교 가능한 근거가 있을 때만 숫자로 제시하고, 근거가 약하면 범위와 신뢰도를 낮게 표시합니다.
8. Output Format에 맞춰 한국어로 리포트를 생성합니다.
